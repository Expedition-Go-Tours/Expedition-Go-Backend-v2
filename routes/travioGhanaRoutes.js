...
/**
 * @swagger
 * /api/travioghana/admin/search:
 *   get:
 *     summary: Search tours for Travio Ghana admin dropdown
 *     description: |
 *       Searches the main Tour table by title for the admin "Add Tour" autocomplete.
 *       Returns tours not yet added to Travio Ghana, or all tours matching the query.
 *       Admin-only.
 *     tags: [Travio Ghana Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: query
 ...
 *                           isAlreadyAdded: { type: boolean, description: 'Whether already on Travio Ghana' }
 *       401:
 *         description: Authentication required
 *       403:
...
/**
 * @swagger
 * /api/travioghana/admin/tours:
 *   get:
 *     summary: List all Travio Ghana tours (admin)
 *     description: |
 *       Returns all TravioGhanaTour records with full tour and adder details.
 ...
 *     responses:
 *       200:
 *         description: Admin list of Travio Ghana tours
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                       type: array
 *                       items:
 *                         $ref: '#/components/schemas/TravioGhanaTour'
 *   post:
 *     summary: Add a tour to Travio Ghana
 *     description: |
 *       Creates a new TravioGhanaTour record linked to an existing Tour.
 *       Validates the tour exists and is not already on Travio Ghana.
 *       Automatically sets `addedById` to the current admin.
 *       Invalidates all Travio Ghana caches on success.
 *       Admin-only.
 *     tags: [Travio Ghana Admin]
 *     security:
 *       - bearerAuth: []
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/TravioGhanaTourInput'
 *     responses:
 *       201:
 *         description: Tour added to Travio Ghana
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                       $ref: '#/components/schemas/TravioGhanaTour'
 *       400:
 *         description: Tour already on Travio Ghana or invalid
 *       404:
 *         description: Tour not found
 */
...
/**
 * @swagger
 * /api/travioghana/admin/tours/{id}:
 *   patch:
 *     summary: Update a Travio Ghana tour
 *     description: |
 *       Updates fields on a TravioGhanaTour record (isActive, isFeatured, displayOrder).
 *       Invalidates all Travio Ghana caches on success.
 *       Admin-only.
 *     tags: [Travio Ghana Admin]
 *     security:
 ...
 *         required: true
 *         schema: { type: string }
 *         description: TravioGhanaTour record ID
 *         example: cmp2hql3c0001tzv0460pbckm
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/TravioGhanaTourUpdate'
 *     responses:
 *       200:
 ...
 *   delete:
 *     summary: Remove a tour from Travio Ghana
 *     description: |
 *       Deletes a TravioGhanaTour record (soft — truly deletes the junction record).
 ...
 *         required: true
 *         schema: { type: string }
 *         description: TravioGhanaTour record ID to remove
 *         example: cmp2hql3c0001tzv0460pbckm
 *     responses:
 *       204:
 *         description: Tour removed from Travio Ghana
 *       404:
 *         description: Travio Ghana tour not found
 */
...
/**
 * @swagger
 * /api/travioghana/admin/refresh/{tourId}:
 *   post:
 *     summary: Refresh Travio Ghana cache
 *     description: |
 *       Invalidates Redis caches for Travio Ghana listings, featured tours, sitemap, and tour details.
 *       If `tourId` is provided and is not `all`, only caches related to that specific tour are cleared.
 *       If `tourId` is omitted or `all`, all Travio Ghana caches are cleared.
 *       Admin-only.
 *     tags: [Travio Ghana Admin]
 *     security:
 *       - bearerAuth: []
 ...
 *         required: false
 *         schema: { type: string }
 *         description: Specific TravioGhanaTour ID or 'all' to clear everything
 *         example: all
 *     responses:
 *       200:
 ...
 *               properties:
 *                 status: { type: string, example: success }
 *                 message: { type: string, example: All Travio Ghana caches cleared }
 *       404:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/overview:
 *   get:
 *     summary: Travio Ghana analytics overview
 *     description: |
 *       Returns aggregate metrics for Travio Ghana: total bookings, revenue,
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/revenue-trend:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/tour-performance:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/bookings:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/conversion-funnel:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/customers:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/cart-abandonment:
 *   get:
...
/**
 * @swagger
 * /api/travioghana/admin/analytics/search:
 *   get:
