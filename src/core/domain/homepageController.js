...
const { SECTION_KEYS } = require('../services/homepagePrecompute');
const { enqueueHomepagePrecompute } = require('../services/queue');
...
async function computeOffersData(city = null) {
  ...
  const { extractStartingPrice } = require('../services/homepageRanking');
