...
const FLAT_BLOB_SOURCES = {
  ...
  productContent: [
    ...
    'mealType', 'showDietaryRestrictions', 'drinksIncluded', 'dietaryOptions', 'dayLogistics',
...
const FLAT_BLOB_INJECTS = {
  ...
  productContent: {
    own: [
      ...
      'petFriendly', 'wheelchairAccessible', 'wifiIncluded', 'emergencyCountryCode', 'emergencyPhone', 'voucherInfo',
